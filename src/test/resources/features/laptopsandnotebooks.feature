Feature: Laptops & Notebooks Feature
  ...
  Scenario: User should see the products as price high to low
    ...
    And I enter first name "ravi" in billing details
    ...
    And I enter billing address "A3 Harrow Road" in the billing details
    And I enter city "Harrow" in the billing details
    And I enter postcode "BN177JN"  in the billing details
